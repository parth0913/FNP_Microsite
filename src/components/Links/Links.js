...
const links = [
  { type: "link", label: "Same Day",imageSrc:"https://beta.fnp.com/icons/same-day-desktop.svg",
    url: "/same-day-delivery" },
  { 
    type: "dropdown",imageSrc:"https://beta.fnp.com/icons/currency-icons/inr.svg", label: "Currency", options: [
      { label: "USD",imageSrc:"https://beta.fnp.com/icons/countries-flags/usa.svg", url: "/currency/usd" },
      { label: "INR",imageSrc:"https://beta.fnp.com/icons/countries-flags/india.svg", url: "/currency/inr" },
      { label: "EUR",imageSrc:"https://beta.fnp.com/icons/countries-flags/germany.svg", url: "/currency/eur" },
      { label: "THB",imageSrc:"https://beta.fnp.com/icons/countries-flags/thailand.svg", url: "/currency/thb" },
      { label: "SGD",imageSrc:"https://beta.fnp.com/icons/countries-flags/singapore.svg", url: "/currency/sgd" },
      { label: "NZD",imageSrc:"https://beta.fnp.com/icons/countries-flags/new-zealand.svg", url: "/currency/nzd" },
    ] 
  },
